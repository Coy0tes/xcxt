...
<button class="btn btn-primary btn-outline btn-sm" data-toggle="tooltip" data-placement="left" onclick="edit()" title="编辑"><i class="fa fa-file-text-o"></i> ${label==null?'编辑':label}</button>
                        </button>
