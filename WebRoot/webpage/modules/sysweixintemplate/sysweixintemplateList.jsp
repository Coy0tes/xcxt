	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead>
			<tr>
				...
				<th  class="sort-column bh">模板编号</th>
				<th  class="sort-column templateid">模板ID</th>
				<th  class="sort-column ison">是否开启</th>
		...
		<c:forEach items="${page.list}" var="sysweixintemplate">
			<tr>
				...
				<td>
					${fns:getDictLabel(sysweixintemplate.ison,'yes_no','') }
				</td>
				<td>
				...
				<td>
					...
					<shiro:hasPermission name="sysweixintemplate:sysweixintemplate:edit">
    					<a href="#" onclick="openDialog('编辑模板信息', '${ctx}/sysweixintemplate/sysweixintemplate/form?id=${sysweixintemplate.id}','800px', '500px')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i> 编辑</a>
    				</shiro:hasPermission>
    				<shiro:hasPermission name="sysweixintemplate:sysweixintemplate:del">
