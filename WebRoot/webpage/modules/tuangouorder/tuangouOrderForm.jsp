...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="tuangouOrder" action="${ctx}/tuangouorder/tuangouOrder/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					...
					<td class="width-15 active"><label class="pull-right">菜品明细：</label></td>
					<td class="width-35">
						${tuangouOrder.rem}
					</td>
				</tr>
				...
				<%-- <tr>
					<td class="width-15 active"><label class="pull-right">作废处理人：</label></td>
					<td class="width-35">
						<form:input path="principal" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">作废时间：</label></td>
					<td class="width-35">
						<form:input path="zuofeitime" htmlEscape="false"    class="form-control "/>
						<form:input path="zuofeitime" htmlEscape="false"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  class="form-control required" readonly="true"/>
					</td>
				</tr> --%>
		 	</tbody>
		</table>
