...
<body class="gray-bg">
	...
	<form:form id="inputForm" modelAttribute="tuangouOrder" action="${ctx}/tuangouorder/tuangouOrder/piliangFahuo" method="post" class="form-horizontal">
	...
	<div class="col-sm-12">
		<div class="pull-left">
			...
			<shiro:hasPermission name="tuangouorder:tuangouOrder:add">
				<table:addRow url="${ctx}/tuangouorder/tuangouOrder/form" title="菜品订单" width="60%" height="80%"></table:addRow><!-- 增加按钮 -->
			</shiro:hasPermission>
			<div hidden="hidden">
				<shiro:hasPermission name="tuangouorder:tuangouOrder:edit">
				    <table:editRow url="${ctx}/tuangouorder/tuangouOrder/form" title="菜品订单" id="contentTable" width="60%" height="80%"></table:editRow><!-- 编辑按钮 -->
				</shiro:hasPermission>
			</div>
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead>
			<tr>
				...
				<th  class="sort-column tuangouname">团购</th>
		...
		<c:forEach items="${lists}" var="tuangouOrder">
			<tr>
				...
				<td> <input type="checkbox" name="id" id="${tuangouOrder.id}" class="i-checks"></td>
				<td>
					${tuangouOrder.ddh}<br/>
				</td>
				<td>
					${tuangouOrder.tuangouname}<br/>
				</td>
				<td>
