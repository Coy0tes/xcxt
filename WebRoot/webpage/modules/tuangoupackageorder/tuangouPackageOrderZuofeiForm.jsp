		...
		function doSubmit(){//回调函数，在编辑和保存动作时，供openDialog调用提交表单。
		  if(validateForm.form()){
			  ...
			  // 选择退款时对退款金额效验
					...
					var sftk = $("input[name=sftk]:checked").val();
					if(!sftk){
			  ...
			  // 退款金额效验
			if(${tuangouPackageOrder.sfprice}<$("#tkje").val()){
...
<body class="hideScroll">
	<form:form id="inputForm" modelAttribute="tuangouPackageOrder" action="${ctx}/tuangoupackageorder/tuangouPackageOrder/zuofeiSave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="tkje" htmlEscape="false"    class="form-control number"/>
					</td>
				</tr>
				<tr>
					...
					<td class="width-15 active"><label class="pull-right">订单取消状态：</label></td>
					<td class="width-35">
